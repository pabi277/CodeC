...
- **Phase 36** (terminal speed & UX) — ✅ DEVICE-PASSED by owner report on `arena/01a086a0-codec`; progressive output, background survival, and session-switch follow-ups passed after `da126cf`/`11fe8d7`, with green CI `34374983032`/`34375710614`; merge authorized and in progress — `docs/chat-phase36/`
