...
- **Phase 33** (first-hour UX) — ✅ 33.0 (RUN ▶ chooser) DEVICE-PASSED + MERGED via PR #57; 🚧 33.1–33.3 IMPLEMENTED on `arena/01a085e0-codec` (CI + owner device round pending) — `docs/chat-phase33/`
...
2. Phases 20.1–27 are MERGED; 28.2 is MERGED (28.3/28.4 remain planned);
   ...
   **Phase 31 is MERGED via PR #56; Phase 32 (phone canvas) is DEVICE-PASSED
   ...
   `arena/01a085e0-codec`** (owner: "Start phase 33") — CI + the owner device
   round (`TROUBLESHOOTING.md` §24) are their gates; see the head line.
