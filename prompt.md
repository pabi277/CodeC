...
- **Phase 36** (terminal speed & UX) — 🚧 STARTED on `arena/01a086a0-codec`; measurement/readiness implementation and CI/device gates open — `docs/chat-phase36/`
