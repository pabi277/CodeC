...
- **Phase 44** (setup you can see, and cannot half-finish) — 🚧 IMPLEMENTED on `arena/01a0955a-codec` (both parts, 109 host cases green locally, CI pending); **device round NOT run** — `docs/chat-phase44/DEVICE_ROUND.md` — `docs/chat-phase44/`
