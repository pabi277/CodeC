...
- **Phase 29 (all three parts in one build) — TextMate is the editor's
  ...
  **Gate: `Build APK` green + owner device round per
  ...
  BOM 2024.12.01) + `db56824` (atomic replay). **Device round re-test pending** (`TROUBLESHOOTING.md`
