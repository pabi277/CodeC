...
**No app code exists for any of them, and Phase 37's merge is still HELD at the
gate** — the owner said "before I merge". Start one only on "Start Phase N";
...
2. Phases 20.1–27 are MERGED; 28.2 is MERGED (28.3/28.4 remain planned);
   ...
   **Phase 37 (device-as-server LAN) is IMPLEMENTED, CI GREEN and
   ...
   shipped on the same branch** — the phase series is therefore complete and
   only the merge gate remains
   ...
   round: done — report Phase 37, then stop at the merge gate.
