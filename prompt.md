...
- **Phase 35** (editor typing feel) — 📋 PLANNED (researched + specced, not implemented) — `docs/chat-phase35/`
- **Phase 34** (official file icons) — 📋 PLANNED (researched + specced, not implemented) — `docs/chat-phase34/`
...
2. Phases 20.1–27 are MERGED; 28.2 is MERGED (28.3/28.4 remain planned);
   ...
   **Phase 31 is MERGED via PR #56; Phase 32 (phone canvas) is DEVICE-PASSED
   ...
   then resumed phased **UX/UI** work: **phases 34–37 are PLANNED**
   (`docs/PHASE34_37_ROADMAP.md`) — 34 official file icons, 35 editor typing
   feel, 36 terminal speed & UX, 37 device-as-server LAN. They start on the
   owner's **"Start Phase N"** and finish with a cross-device round; see the
   head line. No self-initiated phase starts otherwise.
