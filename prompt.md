...
- **Phase 37** (device as server / LAN) — 📋 PLANNED (researched + specced, not implemented) — `docs/chat-phase37/`
- **Phase 36** (terminal speed & UX) — 📋 PLANNED (researched + specced, not implemented) — `docs/chat-phase36/`
- **Phase 35** (editor typing feel) — 🚧 IMPLEMENTED on `arena/01a086a0-codec`; Build APK CI `34367008019` ✅ GREEN on `317b89a`; owner cross-device round pending; measurement card `docs/chat-phase35/MEASUREMENT_CARD.md` — `docs/chat-phase35/`
...
2. Phases 20.1–27 are MERGED; 28.2 is MERGED (28.3/28.4 remain planned);
   ...
   **Phase 31 is MERGED via PR #56; Phase 32 (phone canvas) is DEVICE-PASSED
   ...
   implemented on this session branch with CI/device gates pending, and
   phases 36–37 remain planned (`docs/PHASE34_37_ROADMAP.md`) — 34 official
   file icons, 35 editor typing feel, 36 terminal speed & UX, 37 device-as-
   server LAN. Each starts on the owner's **"Start Phase N"** and finishes
   with a cross-device round; see the head line. No self-initiated phase
   starts otherwise.
