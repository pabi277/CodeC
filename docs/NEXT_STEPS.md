...
**Last updated:** 2026-09-01 · **State (head):** **`main` = `f868e10`** —
Phases 3–14, 19 and 15–17 all MERGED (PR #34 @ `b869ce6`, PR #36 @ `a0e7dc3`,
PR #37 @ `f868e10`). **Phase 18 (CodeCApi Device Capabilities) ✅ COMPLETE &
DEVICE-ACCEPTED (2026-09-01, `arena/01a05b12-codec` `d49ac47`, CI
`33468442063` + `33471103959`) and ready to merge — the only phase not yet on
`main`.** The 2026-09-01 Web Preview `File not found` fix (`d49ac47`) is on
the same branch (record: `chat-phase9/PART_9_IMPLEMENTATION.md` follow-up).
**No remaining spec'd implementation.** Owner's future-update mode (no more
phase-by-phase work; owner merges to `main`) is codified in
[`rule.md`](../rule.md) — follow it for any post-Phase-18 change.
