...
**Last updated:** 2026-09-01 · **State (head):** **✅ ALL PHASES MERGED — `main` = `f868e10` + PR #38** (Phase 18 + Web Preview fix + `rule.md`, merged 2026-09-01 on the owner's "Create pr and marge"; verify the tip). Phases 3–14, 19 (PR #34 @ `b869ce6`), 15/16 (PR #36 @ `a0e7dc3`), 17 (PR #37 @ `f868e10`) and **Phase 18 (PR #38)** are all merged. **No remaining spec'd implementation.** Owner's future-update mode (no more phase-by-phase work; owner merges to `main`) is codified in [`rule.md`](../rule.md) — follow it for any post-Phase-18 change.
