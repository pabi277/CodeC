...
**Status:** 🚧 **D.1 + D.2 IMPLEMENTED** (2026-09-03, `arena/01a064e0-codec`) — D.3 device pass required, D.4 blocked on it. Implementation record: [`PART_21_IMPLEMENTATION.md`](PART_21_IMPLEMENTATION.md).
