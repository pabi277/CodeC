...
- **[Part 6.1 — Safe-area / cutout + extra-keys + wake lock + URL / BEL / title / selection copy](PART_6_TERMINAL_UX.md)** — ✅ IMPLEMENTED (2026-08-28); all 7 sub-fixes implemented and host-tested.
