...
- **[Part 5.1 — Client fixes KI-1 & KI-2](PART_5_1_KI_FIXES.md):** 🚧 **IN
  PROGRESS.** KI-1: `pkg install` of an already-newest package reports
  success (treats apt's "0 newly installed" as success). KI-2: `$PREFIX`
  canonicalized to the dpkg-recorded `/data/data/…` spelling at shell setup.
