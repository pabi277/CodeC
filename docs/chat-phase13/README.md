...
**Status: ✅ COMPLETE & DEVICE-ACCEPTED (2026-08-31, `arena/01a053b3-codec`)** —
every §7 recipe step passed on device (see §8 acceptance record); `Build APK`
CI green (`33326161083`, 37 new host tests). Remaining: the owner's word to
open the PR.
