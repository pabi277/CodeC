...
> **Status:** ✅ **MERGED to `main` via [PR #77](https://github.com/pabi277/CodeC/pull/77)** (merge commit `a475fe4`, 2026-09-13) · 🚧 **IMPLEMENTED** (2026-09-12, `arena/01a0955a-codec`) · CI ✅ GREEN round 1 (`34698914219`, tip `3c597b2`) · device round required (NOT run) · **Cost:** `[client-only]` · **Effort:** M ·
