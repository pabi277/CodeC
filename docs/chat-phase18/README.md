...
part doc §5.6). **Not merged yet** — the branch tip `d49ac47` also carries
the 2026-09-01 Web Preview `File not found` fix (record: `chat-phase9`
PART_9 follow-up; run `33471103959`). Merge to `main` awaits the owner per
[`rule.md`](../../rule.md).
