...
**Status (2026-09-01):** ✅ **COMPLETE & DEVICE-ACCEPTED & MERGED via PR #38** — all five CLI
...
part doc §5.6). The PR also carried the 2026-09-01 Web Preview `File not
found` fix (record: `chat-phase9` PART_9 follow-up; run `33471103959`) and
the future-update manual [`rule.md`](../../rule.md).
