...
**Last updated:** 2026-09-01 · **State:** **`main` = `f868e10`** — Phases
...
DEVICE-ACCEPTED (2026-09-01) but NOT yet merged** — it lives on
`arena/01a05b12-codec` @ `d49ac47` (feature `012deea`, lint fix `4460306`,
docs `6c67202`, plus the 2026-09-01 Web Preview fix `d49ac47`; CI green
`33468442063` / `33468793012` / `33471103959`). **No remaining spec'd
implementation — the owner's future-update mode is defined in
[`rule.md`](../rule.md) (owner will not run phases anymore and merges to
`main`).**
