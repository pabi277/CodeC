...
33. **Phase 24 — desktop-class editor quality (2026-09-03, `arena/01a06784-codec`, owner: "Start Phase 24").** Nine spec parts (E.1–E.9) in `docs/chat-phase24/`; implementation in one branch, one commit set. Device pass REQUIRED (owner's recipes §3 of each part); no PR/merge without owner's command.
