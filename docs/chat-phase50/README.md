...
|---|---|---|---|
| [50.1](PART_50_1_TOKENS.md) | One scale, not 801 numbers | M | 📋 PLANNED |
| [50.2](PART_50_2_IDENTITY_COLOR.md) | A brand you can see on Android 12+ | M | 📋 PLANNED |
| [50.3](PART_50_3_TYPE_AND_ICON.md) | A type scale and one icon set | S/M | 📋 PLANNED |
| [50.4](PART_50_4_MOTION.md) | Motion, for the first time | M | 📋 PLANNED |
